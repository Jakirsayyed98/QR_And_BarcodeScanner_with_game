...
import com.jhcreativedeveloper.BarcodeScanner.databinding.GameLayoutBinding
import java.text.DecimalFormat

class GamesAdapter <S>(private val clickListener: RecyclerClickListener) :
    BaseRecyclerAdapter<S, GamesAdapter<S>.Holder>() {
    private var morePos = 0
    private var showRupee = true
    var totalplays=""


    inner class Holder(private val binding: GameLayoutBinding) :
        ...
        fun setData(s: S) {
            ...
            Glide.with(itemView.context).load(image).centerCrop()
                   // .circleCrop()
                    .into(binding.image)
...
//                    .into(binding.banner)
                 ...
                 binding.plays.text = plays+" Plays"
